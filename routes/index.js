...
router.get('/company/:id/edit',middleware.authGuard,companyController.editCompany);
...
router.post('/company/:id/edit',middleware.companyUpdateValid,catchErrors(companyController.updateCompany));
